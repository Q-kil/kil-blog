...
<meta charset="utf-8">
<title>聂开发的简历-拉勾网-最专业的互联网招聘平台</title>
...
.mr_created #mr_mr_head{margin-bottom:0;}
.mr_created #mr_mr_head *,.mr_created .mr_myresume_r *{list-style:none;}
.mr_top_bg{position:relative;height:135px;background:url(https://www.lgstatic.com/images/myresume/head_bg.jpg);z-index:2;}
...
.mr_left_bg,.mr_right_bg{position:absolute;background: url(https://www.lgstatic.com/images/myresume/top_bg.png) no-repeat;width:12px;height:34px;top:76px;}
.mr_left_bg{left:-1px;background-position:0 0;}
.mr_right_bg{right:-2px;background-position:-40px 0;}
.mr_my_qr{position:absolute;cursor:pointer;z-index:10;right:52px;top:0;width:48px;height:50px;background:#f2f2f2 url(https://www.lgstatic.com/images/myresume/qr_bg.png) 10px 10px no-repeat;}
.mr_my_qr .dropdown_menu {width:288px;height:154px;background:url(https://www.lgstatic.com/images/qr/saowo_bg.png) no-repeat;color: #fff;display:block;padding:18px 8px 8px 8px;margin:50px 0 0 -220px;opacity: 0;visibility: hidden;-webkit-transition:.25s;transition:.25s;}
...
.mr_edit i {display: inline-block;width: 12px;height: 14px;background: url(https://www.lgstatic.com/images/myresume/icons_mr.png) -53px -6px no-repeat;margin-right: 7px;}
...
.mr_locks{position:absolute;width:30px;height:30px;top:8px;right:8px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -144px -83px no-repeat;}
...
span.mr_man i,span.mr_women i{display:inline-block;width:16px;height:16px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) no-repeat;}
...
.mr_add_sns i{display:inline-block;margin-right:10px;width:15px;height:15px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -5px -69px no-repeat;}
...
.mr_add_m li.mr0{margin-right:0;}
.mr_add_m .sns1{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -2px 3px no-repeat;}
.mr_add_m .sns2{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -54px 3px no-repeat;}
.mr_add_m .sns3{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -106px 3px no-repeat;}
.mr_add_m .sns4{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -158px 3px no-repeat;}
.mr_add_m .sns5{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -210px 3px no-repeat;}
.mr_add_m .sns6{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -261px 3px no-repeat;}
.mr_add_m .sns7{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -312px 3px no-repeat;}
.mr_add_m .sns8{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -364px 3px no-repeat;}
.mr_add_m .sns9{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -415px 3px no-repeat;}
.mr_add_m .sns10{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -467px 3px no-repeat;}
.mr_add_m .sns11{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -518px 3px no-repeat;}
.mr_add_m .sns12{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -570px 3px no-repeat;}

.mr_add_m .sns1.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -1px -43px no-repeat;}
.mr_add_m .sns2.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -54px  -43px no-repeat;}
.mr_add_m .sns3.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -106px  -43px no-repeat;}
.mr_add_m .sns4.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -158px  -43px no-repeat;}
.mr_add_m .sns5.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -210px  -43px no-repeat;}
.mr_add_m .sns6.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -261px  -43px no-repeat;}
.mr_add_m .sns7.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -313px  -43px no-repeat;}
.mr_add_m .sns8.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -364px  -43px no-repeat;}
.mr_add_m .sns9.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -415px  -43px no-repeat;}
.mr_add_m .sns10.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -467px  -43px no-repeat;}
.mr_add_m .sns11.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -518px  -43px no-repeat;}
.mr_add_m .sns12.active{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -570px  -43px no-repeat;}
...
.mr_sns_m i{position:absolute;left:-43px;top:7px;width:30px;height:30px;background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) no-repeat;}
...
.mr_sns_m .mr_ok{background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -4px -46px no-repeat;}
...
.mr_moudle_head .mr_head_r i{display: inline-block;width: 15px;height: 15px;background: url(https://www.lgstatic.com/images/myresume/icons_mr.png) -5px -69px no-repeat;margin-right:6px;}
...
.mr_content_l .l2 a.projectTitle span{position:absolute;top:14px;right:-18px;width:12px;height:12px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -95px -197px no-repeat;}
...
.mr_wo_show .mr_c_r_t i{background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -131px -115px no-repeat;}
.wh43{width:100%;}
...
#selfDescription .mr_head_r i,#expectJob .mr_head_r i,#skillsAssess .mr_head_r i,#customBlock .mr_head_r i{display: inline-block;width: 15px;height: 15px;background: url(https://www.lgstatic.com/images/myresume/icons_mr.png) -53px -6px no-repeat;margin-right: 7px;}
...
.mr_self_l i{position:absolute;z-index:2;width:81px;height:81px;background:url(https://www.lgstatic.com/images/myresume/mr_txs.png) no-repeat;}
...
.mr_skill_con .mr_skill_delete{width:13px;height:13px;background:url(https://www.lgstatic.com/images/myresume/skill_delete.png) center top no-repeat;cursor:pointer;}
.mr_moudle_content .mr_skill_add{padding-left:125px;*padding-left:104px;color:#999999;font-size:16px;}
.mr_skill_add span{display:inline-block;width:88px;text-indent:22px;background:url(https://www.lgstatic.com/images/myresume/skill_add.png) left 3px no-repeat;cursor:pointer;}
...
.mr_skill_con .mr_skill_circle{display:inline-block;width:20px;height:19px;position:absolute;left:122px;top:3px;background:url(https://www.lgstatic.com/images/myresume/skill_circle.png) no-repeat center top;}
.mr_skill_circle em{display:inline-block;width:29px;height:23px;position:absolute;right: -4px;top: -22px;text-align: center;line-height:18px;padding: 0px;color: #ffffff;background:url(https://www.lgstatic.com/images/myresume/skill_img.png) center top no-repeat;font-size:10px;}
...
.mr_sns .sns1,.mr_sns_m .sns1,.mr_add_m .sns1{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -4px -5px no-repeat;}
.mr_sns .sns2,.mr_sns_m .sns2,.mr_add_m .sns2{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -56px -5px no-repeat;}
.mr_sns .sns3,.mr_sns_m .sns3,.mr_add_m .sns3{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -108px -5px no-repeat;}
.mr_sns .sns4,.mr_sns_m .sns4,.mr_add_m .sns4{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -160px -5px no-repeat;}
.mr_sns .sns5,.mr_sns_m .sns5,.mr_add_m .sns5{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -212px -5px no-repeat;}
.mr_sns .sns6,.mr_sns_m .sns6,.mr_add_m .sns6{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -263px -5px no-repeat;}
.mr_sns .sns7,.mr_sns_m .sns7,.mr_add_m .sns7{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -314px -5px no-repeat;}
.mr_sns .sns8,.mr_sns_m .sns8,.mr_add_m .sns8{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -366px -5px no-repeat;}
.mr_sns .sns9,.mr_sns_m .sns9,.mr_add_m .sns9{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -417px -5px no-repeat;}
.mr_sns .sns10,.mr_sns_m .sns10,.mr_add_m .sns10{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -469px -5px no-repeat;}
.mr_sns .sns11,.mr_sns_m .sns11,.mr_add_m .sns11{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -520px -5px no-repeat;}
.mr_sns .sns12,.mr_sns_m .sns12,.mr_add_m .sns12{background:url(https://www.lgstatic.com/images/myresume/sns_bg.png) -572px -5px no-repeat;}
...
.mr_bottom_l i{display:inline-block;margin-right:10px;width:16px;height:12px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -90px -140px no-repeat;}
.mr_bottom_l em{color:#c5c5c5;}
.mr_bottom .mr_down:hover em{color:#333;}
.mr_bottom .mr_down:hover i{background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -117px -140px no-repeat;}
...
.mr_sns_m .mr_no{background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -28px -46px no-repeat;}
.mr_sns_m .sns_del{position:absolute;width:16px;height:16px;right:-30px;top:15px;background:url(https://www.lgstatic.com/images/myresume/icons_mr.png) -57px -49px no-repeat;}
.mr_add_sns{position:relative;}
.m_portrait{width:100%;height:135px;position:relative;z-index:2;background:url(https://www.lgstatic.com/images/myresume/head_bg.jpg) no-repeat;}
...
.m_portrait div {
	/* background: url(https://www.lgstatic.com/images/profile_cover.png) no-repeat;
	width: 120px;
	height: 120px;
	position: absolute;
	z-index: 5; */
...
.social-page__list {width: 100%;}
.social-page__list li {margin-top: 20px;list-style: none;} 
.social-page__list a {color: #333;} 
.social-page__list a:hover {color: #333;} 
.social-page__list {margin-bottom: 30px;}
.social-page__list img {display: inline-block;width: 20px;height: 20px;padding-right: 13px;vertical-align: middle;}
.social-page__list span {width: 500px;display: inline-block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;vertical-align: middle;}
		...
		<div class="mr_myresume_l mrcenter">
			<div id="mr_mr_head">
				<div class="m_portrait mr_top_bg">
					<img src="https://www.lgstatic.com//images/myresume/tou.png" class="opa" alt="" />
					<img src="https://www.lgstatic.com/i/image2/M01/87/51/CgoB5luPK42AQDb0AADdI8MjB8I567.jpg" width="120" height="120" alt="" />
				</div>
				<div class="mr_baseinfo">
					<i class="mr_left_bg"></i>
					<i class="mr_right_bg"></i>
					<div class="mr_p_name mr_w604 clearfixs">
						<span class="mr_name">聂开发</span>
					</div>
					<div class="mr_p_info mr_infoed mr_w604 clearfixs">
						<div class="info_t">
							<span class="shenfen">
								<i></i>
								独立前端开发 / 协作服务端开发 · 上海远近网络有限公司
							</span>
						</div>
						<div class="info_t">
							<span class="base_info"><i></i>男&nbsp;&nbsp;&nbsp;23岁&nbsp;&nbsp;&nbsp;本科<span>
							<span class="job_span">&nbsp;3年工作经验</span>
							<span>&nbsp;&nbsp;&nbsp;上海</span>
						</div>
						<div class="info_b">
							<span class="mobile"><i></i>13215693218</span>&nbsp;&nbsp;
							<span class="email"><i></i>kaifaweb@163.com</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div id="selfDescription">
						<div>
							...
							<div class="mr_moudle_content clearfixs">
								<div class="mr_self_r">
									<p>科班出身，对硬件软件都有经验，对前端服务端，运维监控有项目方案。</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="list_show">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<h4>上海远近网络有限公司</h4>
											<span>独立前端开发 / 协作服务端开发</span>
										</div>
									</div>
									<div class="mr_content_r">
										<span>2017.09 -- 2018.09</span>
									</div>
								</div>

								<div class="mr_content_m olpf">
									<p>1、独自负责公司官网和后台等页面的开发，部署，迭代，维护<br />2、探讨制定服务端架构，数据库选型，交互接口编写，服务器运维<br />3、对线上的服务器节点自动进行实时探测，监控，报警；对瘫痪服务器维护<br />4、测试公司各端产品，提高用户体验，完善产品</p>
<p><br /></p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									...
									<div class="mr_content_r">
										<span>2016.08 -- 2017.08</span>
									</div>
								</div>

								<div class="mr_content_m olpf">
									<p>1、与UI团队紧密配合，负责公司PC端及移动端产品前端页面原型开发<br /> 2、负责公司现有项目和新项目的前端修改调试和开发工作<br /> 3、负责前端基础模块的开发和维护<br /> 4、与后端工程师研讨技术实现方案，制定服务接口，优化网站前端性能等</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									...
									<div class="mr_content_r">
										<span>2016.03 -- 2016.08</span>
									</div>
								</div>

								<div class="mr_content_m olpf">
									<p>1、在实习公司学习对网络设备的基本更新维护<br /> 2、对公司的网络组建有项目经验，所需路由器，交换机，机柜等所需硬件有方案<br /> 3、对公司的集团电话组建有项目经历，综合布线系统，运营维护等<br /> 4、合作完成车间的监控系统，录像机，摄像头，电源通电，ip分配，监控系统的运行维护</p>
								</div>
								</div>
							</div>
							</div>
							...
							<div class="list_show">
								<div class="clearfixs mb46 mr_jobe_list">
									<div class="mr_content_l">
										<div class="l1">
											...
											<img src="https://www.lgstatic.com/i/image/M00/AD/52/CgqKkVi1E8OAeOBqAAANIbGpDJc81.jpeg"/>
										</div>
										<div class="l2">
											<h4>北京师范大学</h4>
								...
								<div class="clearfixs mb46 mr_jobe_list">
									<div class="mr_content_l">
										<div class="l2">
											<h4>安徽国际商务职业学院</h4>
											<span>大专 · 计算机科学与技术</span>
										</div>
									</div>
									<div class="mr_content_r">
										<span>2014年 - 2017年</span>
									</div>
								</div>
							</div>
							</div>
						...
						<div>
							...
							<div class="mr_moudle_content" id="projectList">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.unblockmy.net"><span></span>UnBlockMy</a>
											<p>协作开发服务端，独立开发前端</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2018.01 -- 2018.09</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>1、独自负责公司官网UnBlockMy.net 和 产品网站app.UnblockMy.net的开发，使用bootstrap做响应式布局，vuejs做单页面框架，webpack做项目打包，github做代码托管（后转入gitlab），nginx部署发布到线上</p>
<p>2、UnBlockMy后台管理系统页面，使用element-ui组件展示，实现了节点添加，节点部署，节点维护，节点配置详情页</p>
<p>3、服务端使用nodejs 和 expressjs框架完成，q.js做异步回调控制流执行每个节点，多线程分发任务，cron.js定时脚本生产节点配置，互斥锁管理任务中的节点，展示文档使用swagger-ui ，前端人员可在线传参请求数据，连接mongoose做数据存储，pm2管理进程，nginx配置链接，cloudflareDNS管理</p>
<p>4、ansible-playbooks 集群化管理节点服务器，自动化部署节点配置</p>
<p>5、使用prometheus做节点实时监控，通过docker容器开启监控主模块，pushgeteway给prometheus一些自定义监控数据，prometheus收集监控数据，分析整合，alertmanger通过rule判断并告警，telegram机器人告警</p>
<p>6、supervisor管理本地ss代理群，定时通过curl探测节点配置，确保线上配置正常</p>
<p><br /></p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.yuanjin.io"><span></span>远近商用专线</a>
											<p>独立前端开发</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2017.09 -- 2018.01</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>1、使用bootstarp做响应式布局，scss预处理语音，element-ui界面</p>
<p>2、使用vue-i18n国际化，实现中英文语音切换</p>
<p>3、使用vuex数据持久化存储</p>
<p>4、使用highcharts图标插件，完成流量使用图形化界面</p>
<p>5、使用momentjs做时间格式化，google-libphonenumber做号码验证</p>
<p>6、运用rem法新增后台管理移动页面</p>
<p>7、运用es6 async await异步请求</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.xiaomishu.com"><span></span>订餐小秘书</a>
											<p>前端开发</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2016.10 -- 2017.05</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>1、编写公共部分静态页面和登录注册页</p>
<p>2、利用angular框架模块化实现用户登录注册功能</p>
<p>3、利用angular-typeahead插件，实现输入框自动补全及高亮功能</p>
<p>4、创建一个服务模块，用于发送jsonp请求本地菜系名称，渲染到页面下拉菜单</p>
<p>5、实现餐厅搜索后指定页面跳转，按地区/人气/价格排序，</p>
<p>6、利用ng-infinite-scroll无限分页插件，实现餐厅无线分页展示效果</p>
<p>7、使用vue框架更新了该项目的登录注册功能</p>
<p>8、利用git管理工具，管理此项目的代码</p>
								</div>
								</div>
							</div>
						</div>
					...
					<div id="socialPage">
							<div class="mr_moudle_head clearfixs">
								<div class="mr_head_l">
									<div class="mr_title">
										<span class="mr_title_l"></span><span class="mr_title_c">社交主页</span><span class="mr_title_r"></span>
									</div>
								</div>
							</div>
							<div class="mr_moudle_content">
								<ul class="social-page__list">
									<li>
										<a target="_blank" href="http://www.kaifaweb.top" rel="nofollow"><img src="https://www.lgstatic.com/common/image/social/default@2x.png"><span>http://www.kaifaweb.top</span></a>
									</li>
								</ul>
							</div>
					</div>
